...
- Packaged app rendered correctly; the empty task list is expected for external users because desktop mode uses its own clean app data directory under `~/Library/Application Support/aicron`.
